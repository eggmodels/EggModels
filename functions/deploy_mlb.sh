...
FUNCTION_NAME="mlb-model-pipeline"
REGION="us-central1"
RUNTIME="python312"

echo "=========================================="
echo "MLB Model Pipeline Deployment"
echo "=========================================="
echo ""
...
echo "   https://console.firebase.google.com/project/${PROJECT_ID}/firestore/data/~2Fmlb_2026~2Fcurrent"
echo ""
echo "3. Your website reads from: Firestore collection 'mlb_2026' document 'current'"
echo ""
